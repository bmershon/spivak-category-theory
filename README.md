...
In particular, the course is aimed at introducing enough mechanics from abstract algebra and other disciplines so that one can enjoy a relatively self-contained first forray into the subject. Spivak's text seemed to do this better than most, and it is for this reason that it was chosen as the backbone of this module. Spivak provides motivating examples which make concrete the exceedingly abstract concepts to be found in category theory. This is in part due to his use of [ontological logs](https://en.wikipedia.org/wiki/Olog) (Ologs) to describe relations between things (arrows between objects). This is a unique (maybe controversial) way of representing knowledge espoused by Spivak in 2010.
